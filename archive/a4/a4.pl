...
%@ "Starting Checks"[symbol([scope("bubbleSort",func_def),scope(global,program)],function,"void","bubbleSort"),symbol([scope("printArray",func_def),scope(global,program)],function,"void","printArray"),symbol([scope("main",func_def),scope(global,program)],function,"void","main"),symbol([scope("failure",func_def),scope(global,program)],function,"void","failure"),symbol([scope("failure2",func_def),scope(global,program)],function,"void","failure2")]false.

%@ caught: error(existence_error(procedure,'$clause'/2),'$clause'/2)
%@ caught: error(permission_error(modify,static_procedure,symbol/5),retract/1)
%@ ["bubbleSort",scope(global,program)]2
%@ ["printArray",scope(global,program)]2
%@ ["printArray",scope(global,program)]2
%@ ["main",scope(global,program)]2
